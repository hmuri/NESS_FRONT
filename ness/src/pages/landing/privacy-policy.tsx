    ...
    <div className=" w-full flex justify-center">
      <div className="w-full md:w-[600px]">
        ...
        <div className="text-[#454545] text-[16px] flex flex-col">
          ...
          <span>
            re:coding은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
        ...
        <div className="text-[#454545] text-[16px] flex flex-col">
          ...
          <span>
            re:coding은(는) 서비스 제공을 위해 필요 최소한의 범위에서 개인정보를
            수집・이용합니다. 해당 개인 정보는 제 3자 서비스 업체 또는 타인에게
            공유되지 않습니다.
          </span>
          ...
          <ul style={{ listStyleType: "disc", marginLeft: "30px" }}>
            <li>
              수집・이용 항목 : OAuth ID, 성명, 닉네임, 이메일 주소, 프로필 사진
            </li>
          </ul>
          <span className="text-black mt-[5px]">
        ...
        <div className="text-[#454545] text-[16px] flex flex-col ">
          ...
          <span>
            ...
            파기합니다. 해당 개인 정보는 소셜 로그인(Google)로 받은 개인 정보 및
            서비스를 이용하며 생긴 모든 종류의 개인 정보를 포함합니다. 개인정보
            파기의 절차 및 방법은 다음과 같습니다.
          </span>
          <span className="text-black mt-[5px]">[파기절차]</span>
          <span>
            re:coding 은(는) 파기 사유가 발생한 개인정보를 선정하고, re:coding의
            개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
          </span>
          <span className="text-black mt-[5px]">[파기방법]</span>
          <span>
            re:coding 은(는)전자적 파일 형태로 기록・저장된 개인정보는 기록을
            재생할 수 없도록 데이터베이스에서 삭제하며, 종이 문서에 기록・저장된
        ...
        <div className="text-[#454545] text-[16px] flex flex-col">
          ...
          <span>
            ...
            어려움이 발생할 수 있습니다. re:coding 은(는) 최적화된 맞춤형 서비스
            및 혜택에 필요한 최소한의 행태정보만을 수집하며, 사상, 신념,
            학력・병력 등 개인의 권리・이익이나 사생활을 침해할 우려가 있는
            민감한 행태정보를 수집하지 않습니다.
          </span>
        </div>
